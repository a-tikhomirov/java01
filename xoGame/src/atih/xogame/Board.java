...
public class Board {
     ...
     */
    public static int getMaxSeedsCount(int sizeX, int sizeY) {
    ...
    public boolean isSeedsNumberValid(int seedsNumber) {
        return seedsNumber >= MIN_SIZE && seedsToWin <= getMaxSeedsCount(fieldSizeX,fieldSizeY);
    }
     ...
     */
    public Board() {
        this(MIN_SIZE, MIN_SIZE, MIN_SIZE);
    }
     ...
     */
    public Board(int fieldSizeX, int fieldSizeY, int seedsToWin) {
